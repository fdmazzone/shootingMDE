...
\begin{figure}[h]
 ...
 \caption{Graph solution $(\theta,\theta')$  in in the interval $[0,4\pi]$ of \eqref{eq:problema A} with  $c=2.0$, $\mu =\sum_{j=1}^6(-1)^j\delta_j$.}
 \label{fig:sol}\label{fig:sol}
\end{figure}



\paragraph{\emph{Experiment 1: undamped pendulum}}  In this example, we take  $c=0.0$, $D=\{1,\ldots, 5\}$ (again) and
